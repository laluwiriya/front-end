    ...
    <>
      <div className="w-full left-0 m-0 flex relative  bg-white md:w-[1280px] h-[790px]">
          ...
          <div className="hidden md:flex md:top-0 absolute md:bg-orange-100 md:rounded-full md:w-[1177px] md:h-[1177px] md:left-0">
            <div className="w-[648.74px] h-[652.74px] left-[266px] top-[845px] absolute">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1, rotate: [0, 270] }}
                transition={{ duration: 1 }}
                className="w-[100.74px] h-[100.74px] left-[548px] top-[213px] absolute"
              >
                <div className="w-[100.74px] h-[100.74px] left-0 top-0 absolute bg-stone-300 rounded-full shadow-md object-cover ">
                  <img className="" src="/img2.png" />
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1, rotate: [0, 270] }}
                transition={{ duration: 1 }}
                className="w-[97px] h-[99px] left-[450px] top-[61px] absolute"
              >
              ...
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1, rotate: [0, 270] }}
                transition={{ duration: 1 }}
                className="w-[97px] h-[99px] left-[98px] top-[61px] absolute"
              >
                <div className="w-[94px] h-[94px] left-[2px] top-[2px] absolute bg-stone-300 rounded-full shadow object-cover">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1, rotate: [0, 270] }}
                transition={{ duration: 1 }}
                className="w-[97px] h-[99px] left-0 top-[214px] absolute"
              >
                <div className="w-[94px] h-[94px] left-[2px] top-[2px] absolute bg-stone-300 rounded-full shadow object-cover">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1, rotate: [0, 270] }}
                transition={{ duration: 1 }}
                className="w-[97px] h-[99px] left-[274px] top-0 absolute object-cover"
              >
                <div className="w-[94px] h-[94px] left-[2px] top-[2px] absolute bg-stone-300 rounded-full shadow object-cover ">
        ...
        <div className="justify-start items-center top-[368px] md:w-[289px] md:h-[294.96px] md:left-[727px] md:top-[368px] absolute">
          ...
          <motion.div
            initial={{ opacity: 0, scale: 0.5 }}
            animate={{ opacity: 1, scale: 1, rotate: [0, 0, 270, 270, 0] }}
            transition={{ duration: 1 }}
            className="w-[289px] h-[294.96px] left-0 top-0 absolute"
          >
            <div className="w-[130px] top-1 h-[130px] right-[40px] md:w-[280.06px] md:h-[280.06px] md:left-[5.96px] md:top-[5.96px] absolute md:bg-stone-300 md:rounded-full md:shadow-md md:object-cover">
              <img className="rounded-full" src="/image1.png" />
            </div>
          </motion.div>
          {/* </Spin> */}
        </div>
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
          className="w-[167px] h-[100px] left-[30px] top-[90px] flex-wrap absolute md:w-[367px] md:h-[238px] md:left-[100px] md:top-[276px]"
        >
        ...
        <motion.div
          ...
          className="top-[600px] w-[163px] h-12 left-[100px] md:top-[552px] absolute hover:opacity-90"
        >
          <div className="w-[163px] h-12 left-0 top-0 absolute bg-orange-400 rounded-[69px] shadow hover:bg-orange-300 cursor-pointer" />
        ...
        <div className="top-[597px] left-[250px] w-5 h-5 md:origin-top-left md:w-10 md:h-10 md:left-[1120px] md:top-[670px] absolute">
          <div className="w-10 h-10 left-0 -top-20 absolute origin-top-left bg-orange-400 rounded-full shadow-md">
            <Link href="/conten2" className="text-white">
              <FiArrowRight className="top-[15px] w-10 h-10" />
            </Link>
          </div>
        </div>
        <div className=" top-[597px] left-[70px]  origin-top-left w-10 h-10 md:left-[578px] md:top-[670px] absolute">
          <div className="w-10 h-10 left-0 -top-20 absolute origin-top-left bg-orange-400 rounded-full shadow-md">
            <Link href="/conten3" className="text-white">
              <FiArrowLeft className="top-[15px] w-10 h-10" />
            </Link>
          </div>
        </div>
